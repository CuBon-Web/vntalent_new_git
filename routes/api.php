...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix' => 'candidate'], function () {
		Route::post('list', 'CandidateController@list');
		...
		Route::group(['prefix' => 'category'], function () {
			Route::post('list', 'CandidateCategoryController@list');
			Route::post('create', 'CandidateCategoryController@create');
			Route::get('edit/{id}', 'CandidateCategoryController@edit');
			Route::get('delete/{id}', 'CandidateCategoryController@delete');
		});
	});
	...
	Route::group(['prefix' => 'customer-leads'], function () {
		Route::post('list', 'CustomerLeadController@list');
		Route::get('detail/{id}', 'CustomerLeadController@detail');
		Route::get('delete/{id}', 'CustomerLeadController@delete');
	});
