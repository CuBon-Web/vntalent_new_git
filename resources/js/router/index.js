...
let _routers = [
            ...
            {
                name: 'listCustomerLeads',
                path: '/customer-leads',
                component: _import('customer-leads/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            ...
            },
            {
                name: 'addCandidate',
                path: '/candidate/add',
                component: _import('candidate/add'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                ...
                component: _import('candidate/edit'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'listCandidateCategory',
                path: '/candidate/category',
                component: _import('candidate/category-list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'addCandidateCategory',
                path: '/candidate/category/add',
                component: _import('candidate/category-add'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'editCandidateCategory',
                path: '/candidate/category/edit/:id',
                component: _import('candidate/category-edit'),
                meta: {
                    requiresAuth: true,
                }
            },
