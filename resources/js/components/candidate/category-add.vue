<template>
  <div>
    <h3 class="page-title">Thêm ngành nghề ứng viên</h3>
    <div class="row">
    ...
    <div class="row fixxed">
      <div class="col-12">
        <div class="saveButton">
          <vs-button color="primary" @click="saveData">Thêm mới</vs-button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...mapActions(["addCandidateCategory", "loadings"]),
    saveData() {
      this.errors = [];
      ...
      this.addCandidateCategory(this.objData)
        .then(() => {
          ...
          this.$success("Thêm ngành nghề thành công");
        })
        .catch(() => {
          this.loadings(false);
          this.$error("Thêm ngành nghề thất bại");
        });
    },
  },
};
